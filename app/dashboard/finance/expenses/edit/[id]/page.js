...
export default function EditExpensePage({ params }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMsg = err.message || "Failed to update expense. Please try again.";
      setError(errorMsg);
      showError(errorMsg);
    } finally {
      setIsLoading(false);
  ...
  return (
    <ProtectedRoute permission={PERMISSIONS.EXPENSES.UPDATE}>
      <div className="max-w-[1600px] mx-auto space-y-6 pb-12 px-4 sm:px-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black dark:text-white tracking-tight">Edit Expense</h1>
            <p className="text-gray-500 dark:text-zinc-500 text-sm font-medium">Update expense details</p>
          </div>
        </div>
          ...
          <div className="p-8">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">Update the expense details below</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-gray-100 dark:border-zinc-800">
                ...
                >
                  ...
                  <span>{isLoading ? "Updating..." : "Update Expense"}</span>
                </button>
