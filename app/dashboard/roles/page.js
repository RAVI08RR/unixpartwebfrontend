...
const initialRoles = [
  {
    id: 1,
    name: "Administrator",
    assignedUsersBadge: "Administrator",
    ...
    icon: ShieldCheck,
    accessLevel: "View Access Level",
    lastUpdated: "2 minutes ago",
  },
  {
    id: 2,
    name: "Manager",
    assignedUsersBadge: "Manager",
    badgeColor: "text-blue-600 bg-blue-50 dark:bg-blue-500/10 dark:text-blue-400 border-blue-100 dark:border-blue-500/20",
    icon: UserCog,
    accessLevel: "View Access Level",
    lastUpdated: "1 hour ago", // derived from empty string in mock, assuming some value
  },
  {
    id: 3,
    name: "Warehouse Staff",
    assignedUsersBadge: "Warehouse Staff",
  ...
  },
  {
    ...
    assignedUsersBadge: "Sales Representative",
